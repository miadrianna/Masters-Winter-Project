...
path = c("Ans.Ao.Meta.csv", "../Ao OW Data/Ans.Ao.OWL.csv")
...
plot(Ao.OW ~ Year, na.omit(data[,c("Ao.OW","Year")]), type = "b", pch = 21, cex = 1.5, col = colours[1], lty = 6, lwd = 3, xlab = "Year", ylab = "Prevalence", ylim=c(0,1))
lines(Ao ~ Year, na.omit(data[,c("Ao","Year")]), type = "b", pch = 21,cex = 1.5, col = colours[2], lty = 8, lwd = 3)
legend(2016.5,1,c("Ao","Ao.OW"), fill = colours[1:2],cex = 1.4,pt.cex=0.6)
text(2008,1.12,"(c)", cex = 1.7)
